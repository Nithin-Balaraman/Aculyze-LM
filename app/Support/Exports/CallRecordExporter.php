...
class CallRecordExporter extends ResourceExporter
{
    ...
    /**
     * Mirrors CallRecordResource::getEloquentQuery() exactly:
     * visibleTo($user) (admin sees every call, an employee only their own —
     * see CallRecord::scopeVisibleTo()) plus directlyLogged() (excludes
     * Call Records generated by a Follow-Up's "Completed" action, which
     * exist purely to drive CallRoutingService — see
     * CallRecord::scopeDirectlyLogged()).
     */
