 ...
 * mechanism.
 */
class ProspectLeadsTable extends BaseWidget
{
    ...
    public function table(Table $table): Table
    {
        ...
        return $table
            ->heading("Leads — {$this->record?->company_name}")
            ->query(
            ...
            ->emptyStateHeading('No leads for this company yet.')
